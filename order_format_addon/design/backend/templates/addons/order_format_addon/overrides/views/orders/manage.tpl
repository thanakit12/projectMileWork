            ...
            <div class="table-responsive-wrapper">
                <table width="100%" class="table table-middle table-responsive">
                    ...
                    <tr>
                        ...
                        <th class="mobile-hide">Phone2</th>
                    ...
                    {foreach from=$orders item="o"}
                        {hook name="orders:order_row"}
                            <tr>
                                ...
                                <td {if $o.phone}data-th="{__("phone")}"{/if}><bdi><a href="tel:{$o.phone}">{$o.s_phone_one}</a></bdi></td>
                                <td width="10" {if $o.phone}data-th="{__("phone2")}"{/if}><bdi><a href="tel:{$o.phone}">{$o.s_phone_two}</a></bdi></td>
